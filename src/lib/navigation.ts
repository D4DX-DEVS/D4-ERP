...
export const navigationModules: NavModule[] = [
  // ─── My Portal (staff-only: shown when staff accesses dashboard via feature) ─
  {
    ...
    items: [
      ...
      { label: "New Request", href: "/staff-portal/leave", roles: ["staff"] },
      { label: "My Requests", href: "/staff-portal/my-leaves", roles: ["staff"] },
      { label: "My Leave Balance", href: "/staff-portal/my-leave-balance", roles: ["staff"] },
