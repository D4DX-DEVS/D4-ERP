...
export default function LoginPage() {
  ...
  return (
    <div className="mesh-bg relative h-screen overflow-hidden px-4 py-5 sm:px-6 lg:px-8 lg:py-8">
      <div className="ambient-orb absolute right-[8%] top-[12%] h-40 w-40 rounded-full bg-indigo-300/20 blur-3xl" />
        ...
        <Card className="w-full max-w-xl justify-self-center rounded-[36px]">
          <CardHeader className="pb-3 text-center sm:text-left">
            <div className="mb-5 flex items-center justify-center sm:justify-start">
              <div className="flex h-16 w-16 items-center justify-center rounded-[22px] bg-gradient-to-br from-indigo-700 via-indigo-600 to-violet-600 text-white shadow-[0_18px_44px_rgba(55,48,163,0.25)]">
          ...
          <CardContent>
            ...
            <div className="rounded-[22px] border border-white/70 bg-white/60 px-4 py-4 text-center sm:text-left">
              ...
              <Link href="/staff-login" className="mt-2 inline-flex items-center gap-2 text-sm font-semibold text-indigo-700 hover:text-indigo-800">
                Open staff portal
                <ArrowRight className="h-4 w-4" />
              </Link>
            </div>
